...
function showDescription() {
    ...
    add(`<h1 id="description">
        ...
        into various forms, becoming a popular and portable food option worldwide. Today, they encompass a wide range of ingredients and styles, reflecting culinary innovation across different cultures.
        </h1>`);
}
